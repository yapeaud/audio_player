// Importation du hook personnalisé pour gérer la lecture audio
...
export function MusicPlayer() {
    ...
    const { isPlaying, currentTime, currentFormatedTime, duration, durationFormatedTime, play, pause } = useAudioPlayer("./audio/Darla_Goldengoal.mp3");
